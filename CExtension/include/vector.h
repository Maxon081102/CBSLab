...
/*
 * Function: VectorNewFromBuffer
 * -------------------
 * Constructs a new vector which interprets bytes at `rawBytes` pointer as a
 * contiguous blob of memory with given element size as `elemSize` and count as `lenght`
 */
